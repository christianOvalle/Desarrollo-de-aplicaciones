    ...
    class Program
    {
        static void Main(string[] args)
        {
           ...
           /* MySql.Data.MySqlClient.MySqlCommand Asignacion = muestra.CreateCommand();
            ...
            MySql.Data.MySqlClient.MySqlCommand mySqlCommandread = muestra.CreateCommand();
            mySqlCommandread.CommandText = "select *from producto";
            MySql.Data.MySqlClient.MySqlDataReader mySqlDataReader = mySqlCommandread.ExecuteReader();
            while (mySqlDataReader.Read())
            {
                Console.WriteLine(mySqlDataReader["nombre".ToString()]);
