...
namespace Taller.Models
{
    public class ServiciosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,nombre,tipo_servicio,costo")] Servicios servicios)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,nombre,tipo_servicio,costo")] Servicios servicios)
        {
            if (ModelState.IsValid)
            {
